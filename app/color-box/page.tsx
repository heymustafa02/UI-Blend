...
import { Boxes } from "@/components/ui/_colorbox";
import { cn } from "@/lib/utils";

export default function BackgroundBoxesDemo() {
  return (
    <div className="fixed inset-0 w-full h-full overflow-hidden bg-slate-900 flex flex-col items-center justify-center">
