...
export default function Preview() {
  return (
    <div className="w-full h-screen fixed inset-0 flex flex-col relative font-azeretMono pb-24">
      <div className="absolute top-20 text-6xl sm:text-7xl md:text-8xl text-black w-full text-center font-calendas italic z-10">
        fancy
      </div>
      <p className="absolute top-40 text-base sm:text-xl md:text-2xl text-black w-full text-center z-10">
